...
BIG_TEXT_BOTTOM_MARGIN = MARGIN * 3.5
BIG_TEXT_INTERLINE = MARGIN * 1.5
...
def draw_main_text():
	...
	text("ABCDEFGHIJKLM", (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN + BIG_TEXT_INTERLINE*5), "center")
	text("NOPQRSTUVWXYZ", (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN + BIG_TEXT_INTERLINE*4), "center")
	text("abcdefghijklm", (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN + BIG_TEXT_INTERLINE*3), "center")
	text("nopqrstuvwxyz", (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN + BIG_TEXT_INTERLINE*2), "center")
	text("0123456789,.!?-/", (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN + BIG_TEXT_INTERLINE*1), "center")
	text("`~@#$%^&*()[]{}", (BIG_TEXT_SIDE_MARGIN, BIG_TEXT_BOTTOM_MARGIN), "center")
...
if __name__ == "__main__":
	FONT_PATH = "fonts/otf/LibreDotMatrix-Regular.otf"
	make_image()
	FONT_PATH = "fonts/otf/LibreDotMatrixPrint-Regular.otf"
	make_image()
	FONT_PATH = "fonts/otf/LibreDotMatrixScreen-Regular.otf"
	make_image()
