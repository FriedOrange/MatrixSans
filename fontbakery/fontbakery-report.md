...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: malayalam, old-permic, coptic, tifinagh, tai-le, syriac, todhri, hebrew, duployan, canadian-aboriginal, math</li>
...
<li>U+0331 COMBINING MACRON BELOW: try adding one of: cherokee, thai, caucasian-albanian, tifinagh, gothic, sunuwar, syriac</li>
...
<li>U+2010 HYPHEN: try adding one of: arabic, sundanese, kayah-li, armenian, coptic, kharoshthi, kaithi, cham, hebrew, yi, sora-sompeng, syloti-nagri, lisu</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: marchen, buhid, phags-pa, hanunoo, thai, bengali, oriya, pahawh-hmong, khmer, sogdian, mongolian, rejang, buginese, khudawadi, batak, sinhala, kharoshthi, balinese, mahajani, old-permic, nko, psalter-pahlavi, yi, gujarati, thaana, adlam, mandaic, lao, hanifi-rohingya, brahmi, myanmar, wancho, math, miao, tai-le, takri, meetei-mayek, chakma, devanagari, tagbanwa, grantha, mende-kikakui, music, tirhuta, osage, siddham, khojki, tamil, armenian, kannada, masaram-gondi, tibetan, duployan, canadian-aboriginal, syriac, modi, tai-tham, bassa-vah, dogra, tai-viet, gurmukhi, warang-citi, manichaean, ahom, malayalam, coptic, lepcha, limbu, saurashtra, javanese, symbols, zanabazar-square, kayah-li, caucasian-albanian, tagalog, new-tai-lue, sharada, gunjala-gondi, elbasan, kaithi, cham, sundanese, soyombo, newa, bhaiksuki, tifinagh, telugu, hebrew, syloti-nagri</li>
...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Lugbara (Latn, 2,200,000 speakers), Aghem (Latn, 38,843 speakers), Vute (Latn, 21,000 speakers), Basaa (Latn, 332,940 speakers), Heiltsuk (Latn, 300 speakers), Sar (Latn, 500,000 speakers), Han (Latn, 6 speakers), Koonzime (Latn, 40,000 speakers), Ma’di (Latn, 584,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Igbo (Latn, 27,823,640 speakers), Zapotec (Latn, 490,000 speakers), Mundani (Latn, 34,000 speakers), Avokaya (Latn, 100,000 speakers), Ejagham (Latn, 120,000 speakers), Ekpeye (Latn, 226,000 speakers), Nzakara (Latn, 50,000 speakers), Teke-Ebo (Latn, 260,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Kaska (Latn, 125 speakers), Yala (Latn, 200,000 speakers), Cicipu (Latn, 44,000 speakers), Nateni (Latn, 100,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Mfumte (Latn, 79,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Dii (Latn, 71,000 speakers), Navajo (Latn, 166,319 speakers), Southern Kisi (Latn, 360,000 speakers), Kom (Latn, 360,685 speakers), South Central Banda (Latn, 244,000 speakers), Ebira (Latn, 2,200,000 speakers), Mango (Latn, 77,000 speakers), Bafut (Latn, 158,146 speakers), Dan (Latn, 1,099,244 speakers), Gulay (Latn, 250,478 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Makaa (Latn, 221,000 speakers), Fur (Latn, 1,230,163 speakers).</p>
 [code: soft-dotted]
