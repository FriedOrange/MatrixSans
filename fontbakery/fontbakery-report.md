...
<p>Width = 400:
greaterequal, less, greater, lessequal</p>
 [code: width-outliers]
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: todhri, math, duployan, syriac, tai-le, canadian-aboriginal, tifinagh, malayalam, coptic, hebrew, old-permic</li>
...
<li>U+0331 COMBINING MACRON BELOW: try adding one of: syriac, cherokee, gothic, tifinagh, caucasian-albanian, thai, sunuwar</li>
...
<li>U+2010 HYPHEN: try adding one of: cham, kharoshthi, kaithi, syloti-nagri, arabic, sora-sompeng, lisu, sundanese, yi, armenian, coptic, hebrew, kayah-li</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: sinhala, symbols, pahawh-hmong, armenian, kannada, khudawadi, tai-viet, tirhuta, canadian-aboriginal, warang-citi, ahom, balinese, osage, javanese, elbasan, sogdian, caucasian-albanian, malayalam, lao, tagbanwa, phags-pa, gurmukhi, psalter-pahlavi, brahmi, tai-le, kharoshthi, syloti-nagri, gujarati, manichaean, khojki, chakma, meetei-mayek, marchen, masaram-gondi, kayah-li, math, tifinagh, mende-kikakui, buhid, hebrew, nko, saurashtra, newa, adlam, kaithi, zanabazar-square, thaana, modi, khmer, hanunoo, tagalog, cham, gunjala-gondi, thai, yi, coptic, hanifi-rohingya, syriac, rejang, music, lepcha, old-permic, sharada, grantha, buginese, soyombo, devanagari, bengali, bhaiksuki, dogra, oriya, wancho, sundanese, new-tai-lue, tamil, batak, mandaic, telugu, mongolian, miao, duployan, mahajani, myanmar, limbu, tai-tham, bassa-vah, takri, tibetan, siddham</li>
...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Makaa (Latn, 221,000 speakers), Lugbara (Latn, 2,200,000 speakers), South Central Banda (Latn, 244,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Mfumte (Latn, 79,000 speakers), Teke-Ebo (Latn, 260,000 speakers), Vute (Latn, 21,000 speakers), Ekpeye (Latn, 226,000 speakers), Sar (Latn, 500,000 speakers), Heiltsuk (Latn, 300 speakers), Dan (Latn, 1,099,244 speakers), Igbo (Latn, 27,823,640 speakers), Mango (Latn, 77,000 speakers), Zapotec (Latn, 490,000 speakers), Avokaya (Latn, 100,000 speakers), Ma’di (Latn, 584,000 speakers), Kaska (Latn, 125 speakers), Kom (Latn, 360,685 speakers), Mundani (Latn, 34,000 speakers), Koonzime (Latn, 40,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Nzakara (Latn, 50,000 speakers), Bafut (Latn, 158,146 speakers), Belarusian (Cyrl, 10,064,517 speakers), Southern Kisi (Latn, 360,000 speakers), Yala (Latn, 200,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Han (Latn, 6 speakers), Cicipu (Latn, 44,000 speakers), Nateni (Latn, 100,000 speakers), Gulay (Latn, 250,478 speakers), Ngbaka (Latn, 1,020,000 speakers), Dii (Latn, 71,000 speakers), Aghem (Latn, 38,843 speakers), Ejagham (Latn, 120,000 speakers), Ebira (Latn, 2,200,000 speakers), Navajo (Latn, 166,319 speakers), Fur (Latn, 1,230,163 speakers), Basaa (Latn, 332,940 speakers).</p>
 [code: soft-dotted]
