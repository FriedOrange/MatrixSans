...
video_subs = re.findall(r"sub \w+ by \w+\.alt;", re.search("ss04 {.+?} ss04;", fea_txt, flags=re.DOTALL).group(0))

fea_txt = re.sub("ss04 {.+?} ss04;", lambda m: re.sub(r"(\w+) by (\w+\.alt)", r"\2 by \1", m.group(0)), fea_txt, flags=re.DOTALL)
